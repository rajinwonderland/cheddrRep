...
import FAB from './FAB'
  ...
  class TieredQuickView extends Component {
    render() {
      return (
            <View>
              ...
              <CardItem style={styles.tieredItem}>
                  ...
                  <View style={{
                    ...
                    <List>
                      ...
                      <Text style={{fontFamily: 'HelveticaNeue',fontWeight: 'bold'}}>{this.props.reward1}</Text>
                      <Text style={{fontFamily: 'HelveticaNeue'}}>{this.props.reward2}</Text>
                      <Text style={{fontFamily: 'HelveticaNeue'}}>{this.props.reward3}</Text>
...
export default TieredQuickView
