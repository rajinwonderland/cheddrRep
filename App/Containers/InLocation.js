...
import { View, ScrollView, Text, LayoutAnimation, Keyboard, RefreshControl } from 'react-native'
...
// Styles
import styles from './Styles/InLocationStyle'

console.disableYellowBox = true;


class InLocation extends React.Component {
...
export default connect(mapStateToProps)(InLocation)
